...
//   // const UserRole = session?.user?.role as UserRole || role;
...
//       { label: "All Prompts", href: "/dashboard/admin/prompts", icon: FaList },
//       { label: "Add Prompt", href: "/dashboard/admin/add-prompt", icon: FaPlus },
//       { label: "Settings", href: "/dashboard/admin/settings", icon: FaCog },
//     ]
//   };

//   const currentNavItems = navConfig[role] || navConfig.user;
...
// import { UserRole, NavItem, DashboardSidebarProps } from '@/types/auth'; // আপনার টাইপ ফাইলের সঠিক পাথ দিন
