  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-4 sm:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-2xl font-black text-gray-900">All Food Items</h1>
          <p className="text-xs text-gray-500 mt-1">Manage and update your menu inventory</p>
        </div>

        <Link
          href="/admin/add-food"
          className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-bold px-4 py-2.5 rounded-2xl transition shadow-xs"
        >
      ...
      <div className="bg-white p-4 rounded-3xl border border-gray-100 shadow-xs mb-6 flex flex-col sm:flex-row gap-4 justify-between items-center">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-2xl outline-none focus:border-orange-500 transition"
          />
        </div>
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          <select
            ...
            className="w-full sm:w-48 px-3 py-2 text-sm border border-gray-200 rounded-2xl outline-none focus:border-orange-500 cursor-pointer text-gray-700 font-medium"
          >
      ...
      <div className="bg-white rounded-3xl shadow-xs border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center text-gray-400 font-medium">No menu items found.</div>
        ) : (
